"""LangChain-compatible Python brain for Copiloto Java Generico."""
...
class JavaGenericAgent:
    ...
    def render_prompt(self, request: str, evidence: dict[str, Any] | None = None) -> list[dict[str, str]]:
        ...
        user_payload = {
            ...
            "plan": plan,
            "runtime_parity_contract": redact_value(RUNTIME_PARITY_CONTRACT),
...
def build_agent() -> JavaGenericAgent:
    return JavaGenericAgent()
