# Copiloto SonarQube Remediacion - GitHub Copilot Agents Agent V2
...
- Connector env names only: GITHUB_TOKEN, SONARQUBE_TOKEN
- Connector placeholders: github_mcp, sonarqube_mcp
