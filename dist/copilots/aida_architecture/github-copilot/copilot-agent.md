# Copiloto de Principios de Arquitectura AIDA - GitHub Copilot Agents Agent V2
...
- Connector env names only: GITHUB_TOKEN, CONFLUENCE_TOKEN_OPTIONAL
- Connector placeholders: github_mcp, confluence_mcp_optional
