...
Generated: 2026-05-05T19:40:17.563Z
Source file: factory-prompt.md
Source exists: yes
Policy-sensitive rewrites: 1

## Operating Boundary

- Build authorized local software inside this workspace.
- Treat privacy, reliability, access control, input validation, licensing and release readiness as defensive product-quality checks.
- Use placeholders for credentials and synthetic demo data.
- Use third-party repositories for patterns first; adapt code only with compatible license and attribution.
...
5. Evita meter sensitive credentialsos, tokens o credenciales reales. Solo nombres de variables de entorno.
